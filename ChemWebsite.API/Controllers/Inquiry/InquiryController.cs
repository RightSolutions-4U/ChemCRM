...
namespace ChemWebsite.API.Controllers
{
    ...
    public class InquiryController : BaseController
    {
        ...
        /// <summary>
        /// Gets the chemicals by inquiry Id.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
        [HttpGet("{id}/chemicals")]
        public async Task<IActionResult> GetChemicalsByInquiryId(Guid id)
        {
            var query = new GetInquiryChemicalsQuery { Id = id };
            var result = await _mediator.Send(query);
            return Ok(result);
        }
    }
