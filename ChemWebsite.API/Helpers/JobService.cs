...
namespace ChemWebsite.API.Helpers
{
    public class JobService
    {
        ...
        public bool ExpectedDeliveryForPurchaseOrder()
        {
            return _mediator.Send(new ExpectedDispatchDateReminderServiceQuery()).GetAwaiter().GetResult();
        }

        public bool ExpectedDeliveryForSaleOrder()
        {
            return _mediator.Send(new ExpectedShipmentSalesOrderReminderServiceQuery()).GetAwaiter().GetResult();
        }
