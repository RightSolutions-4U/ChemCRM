...
{
    public class GetChemicalsByCustomerQueryHandler : IRequestHandler<GetChemicalsByCustomerQuery, ChemicalListDto>
    {
        private readonly IChemicalCustomerRepository _chemicalCustomerRepository;
        private readonly IMapper _mapper;

        public GetChemicalsByCustomerQueryHandler(
        ...
        public async Task<ChemicalListDto> Handle(GetChemicalsByCustomerQuery request, CancellationToken cancellationToken)
        {
            var chemicalsQuery = _chemicalCustomerRepository.AllIncluding(c => c.Chemical)
